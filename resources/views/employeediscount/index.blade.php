            ...
            <nav class="col-md-2 col-sm-2 col-xs-2">
                ...
                @else
                    <ul class="nav nav-pills nav-stacked" style="float: left; position: fixed;">
                        <li><button type="submit" class="btn btn-success btn-block" name="process" value="add"><i class="fa fa-plus-circle"></i> Add Employee Discount</button></li>
            ...
            <div class="col-md-10 col-sm-9 col-xs-9 col-md-offset-0 col-sm-offset-1 col-xs-offset-1">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Employee Discounts ({{ number_format($items->count()) }} items)
                    </div>
                    <div class="panel-body">
                        @if(config('pos.driver') == 'orderdog')
                            Employee Discounts are not supported by the OrderDog driver
                        @else
                                ...
                                <table class="table table-striped table-bordered table-hover nowrap">
                                    ...
                                    @foreach ($items as $item)
                                        ...
                                        <tr>
                                            ...
                                            @if(!empty(Request::get('debug')))
                                                <td class="text-nowrap"><strong>SMED{{ $item->id }}</strong></td>
                                            @endif
